...
print(edges)
print(len(edges))
maxValue = helpFunctions.findMaxGrad(edges)
# filtering
...
lines = helpFunctions.findLinesByMaxGrad(edges)
print(lines)
for line in lines:
    cv2.line(img, (line.startPoint[0], line.startPoint[1]), (line.endPoint[0], line.endPoint[1]), (0, 0, 255), 2)
